...
describe('SSR Auth Security - Issue #270', () => {
  it('should extract wallet address from valid session cookie', async () => {
    ...
    const mockValidSession = createMockJWT('GVICTIM1234567890123456789012345678901234567890123456789012345678');
    ...
    if (session) {
      ...
      expect(walletAddress).toBe('GVICTIM1234567890123456789012345678901234567890123456789012345678');
    }
  });
